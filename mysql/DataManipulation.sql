...
BEGIN
	...
	SELECT TRANS_ID FROM T_TRANSANCTION WHERE CLIENT_ID = P_CLIENT_ID AND DRIVER_ID = P_DRIVER_ID AND STATUS = 'IPROG';
END//
DELIMITER ;
...
P_TRANS_ID VARCHAR(32),
P_DRIVER_ID INT,
P_CLIENT_ID INT,
P_DROP_OFF_LOG DECIMAL(9,5),
P_DROP_OFF_LAT  DECIMAL(9,5),
P_STATUS CHAR(5))
BEGIN
	UPDATE T_TRANSANCTION
	SET DROP_OFF_LONGITUDE = P_DROP_OFF_LOG, DROP_OFF_LATITUDE = P_DROP_OFF_LAT, STATUS = P_STATUS
