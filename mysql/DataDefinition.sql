...
INSERT INTO T_USER (USERNAME, SALTED_HASH, FNAME, LNAME, EMAIL, PRIM_PHONE, USER_TYPE, STATUS_TYPE, CURRENT_LONGITUDE, CURRENT_LATITUDE)
	VALUES('Driver1','5E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E03','Driv1','Kent',
		'superman@gmail.com','4086074321','DRIVR', 'OFFLN', 23.21352, 212.12313 ); 

INSERT INTO T_USER (USERNAME, SALTED_HASH, FNAME, LNAME, EMAIL, PRIM_PHONE, USER_TYPE, STATUS_TYPE, CURRENT_LONGITUDE, CURRENT_LATITUDE)
VALUES('Driver2','5E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E04','Driv2','Kent',
	'superman@gmail.com','4086074321','DRIVR', 'LFCLT', -121.847688 ,37.204218); 

INSERT INTO T_USER (USERNAME, SALTED_HASH, FNAME, LNAME, EMAIL, PRIM_PHONE, USER_TYPE, STATUS_TYPE, CURRENT_LONGITUDE, CURRENT_LATITUDE)
VALUES('Driver3','5E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E05','Driv3','Kent',
	'superman@gmail.com','4086074321','DRIVR', 'LFCLT', -121.982669 ,37.367424); 

INSERT INTO T_USER (USERNAME, SALTED_HASH, FNAME, LNAME, EMAIL, PRIM_PHONE, USER_TYPE, STATUS_TYPE, CURRENT_LONGITUDE, CURRENT_LATITUDE)
VALUES('Driver4','5E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E0C65E07','Driv4','Kent',
	'superman@gmail.com','4086074321','DRIVR', 'LFCLT', -121.880520 ,37.334131); 
